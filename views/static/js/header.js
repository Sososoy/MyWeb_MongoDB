$(document).ready(() => {
    ...
    <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
      <li><a href="/views/index.html" class="nav-link px-2 link-secondary">Home</a></li>
      <li><a href="/views/posts/list.html" class="nav-link px-2 link-dark">List</a></li>
    </ul>

    <div class="col-md-3 text-end">
      <button type="button" class="btn btn-outline-primary me-2" onclick="location.href='/views/user/login.html'">Login</button>
      <button type="button" class="btn btn-primary" onclick="location.href='/views/user/signUp.html'">Sign-up</button>
    </div>
  </header>`;
